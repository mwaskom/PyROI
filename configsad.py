...
- sourcefiles : list label or mask image file names, or "all"
...
atlases = {"aseg": 
           ...
           "social":
               {"source": "label",
                "hemi": "lh",
                "sourcedir": "data/pyroi_test_data/grant_labels",
                "sourcefiles": ["lh.cuneus_social.label",
                                "lh.DLPFC_social.label",
                                "lh.IPS_social.label",
                                "lh.occipitalpole_social.label"]
                },
           "harvard":
               {"source": "fsl",
                "prob": 50,
           ...
           "pick_caudate":
               {"source": "mask",
                "sourcedir": "data/pyroi_test_data/caudate_masks",
                "sourcefiles": "all"
               }
           }
...
using any Freesurfer-based or label atlases, just specify an arbitry path.  
...
for the contrast to the number of con image for that contrast.
...
contrast-effect size and T statistic images are in the same directory for each
paradigm/subject).  You may include $paradigm, $subject, and $contrast wild-
cards in the path strings, which will be replaced appropriately as the program
runs. 
...
timecoursepath = "surface/l1output/$paradigm/$subject/timecourse/rf*.img"

meanfuncpath = "surface/l1output/$paradigm/$subject/realign/mean*.nii"
